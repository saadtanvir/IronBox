...
class PlansCategoriesWidget extends StatefulWidget {
  @override
  _PlansCategoriesWidgetState createState() => _PlansCategoriesWidgetState();
}

class _PlansCategoriesWidgetState extends State<PlansCategoriesWidget> {
  ...
  List<String> plansNames = ["Training", "My Workout Plans", "Diet"];
  @override
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            ...
            child: PlanCardWidget(
                name: plansNames[index], imgURL: plansImages[index]),
          );
        },
      ),
    );
